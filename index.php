...
<?php
    ...
    if (mysqli_ping($conn)) {
        ...
        echo '<script>alert("There is an error. Please contact adminstartor")</script>';
        exit;
    }
        ...
        <div class="login-page">
            <div class="form">
                ...
                <form class="login-form" form action="" method="post">
                    ...
                    <p class="message">Are you new? <a href="#">Create an account</a></p>
                    <p class="message">Forgot password? <a href="forgetpass.php">Restore it</a></p>
                </form>
            </div>
        </div>
